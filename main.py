...
router = Router()  # <-- router определяется ЗДЕСЬ
...
def calculate_hours(start_time: str, end_time: str) -> float:
    ...
    try:
        ...
        logger.error(f"❌ Неверный формат времени: {start_time} - {end_time}")
        return 0.0
    except Exception as e:
...
# ════════════════════════════════════════════════════════════════════════════
# 🚗 ОБРАБОТЧИКИ СОСТОЯНИЙ С ОТМЕНОЙ (ПОМЕСТИТЬ ПОСЛЕ router)
# ════════════════════════════════════════════════════════════════════════════
...
# ════════════════════════════════════════════════════════════════════════════
# 🏠 ОБРАБОТЧИКИ КОМАНД (ЭТОТ КОД УЖЕ БЫЛ В ФАЙЛЕ)
# ════════════════════════════════════════════════════════════════════════════
